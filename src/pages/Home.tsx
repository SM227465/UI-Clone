        ...
        <div className="left-container">
          ...
          <div className="chat-list">
            ...
            <div className="chat-box">
              <div className="img-box">
                <img className="img-cover"
                  src="https://imgs.pexels.com/photos/2379005/pexels-photo-2379005.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                  alt="" />
              </div>
              <div className="chat-details">
                <div className="text-head">
            ...
            <div className="chat-box">
              <div className="img-box">
                <img className="img-cover"
                  src="https://imgs.pexels.com/photos/8367221/pexels-photo-8367221.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                  alt="" />
              </div>
              <div className="chat-details">
                <div className="text-head">
            ...
            <div className="chat-box">
              <div className="img-box">
                <img className="img-cover"
                  src="https://imgs.pexels.com/photos/1382731/pexels-photo-1382731.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                  alt="" />
              </div>
              <div className="chat-details">
                <div className="text-head">
            ...
            <div className="chat-box active">
              <div className="img-box">
                <img className="img-cover"
                  src="https://imgs.pexels.com/photos/2474307/pexels-photo-2474307.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                  alt="" />
              </div>
              <div className="chat-details">
                <div className="text-head">
            ...
            <div className="chat-box">
              <div className="img-box">
                <img className="img-cover"
                  src="https://imgs.pexels.com/photos/3564412/pexels-photo-3564412.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                  alt="" />
              </div>
              <div className="chat-details">
                <div className="text-head">
            ...
            <div className="chat-box">
              <div className="img-box">
                <img className="img-cover"
                  src="https://imgs.pexels.com/photos/2919367/pexels-photo-2919367.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                  alt="" />
              </div>
              <div className="chat-details">
                <div className="text-head">
            ...
            <div className="chat-box">
              <div className="img-box">
                <img className="img-cover"
                  src="https://imgs.pexels.com/photos/14526673/pexels-photo-14526673.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                  alt="" />
              </div>
              <div className="chat-details">
                <div className="text-head">
